...
public class SocketHandle implements Runnable {
    ...
    for (int i = 1; i + 7 < message.length; i += 8) {
        list.add(new User(
    ...
    return new User(
        Integer.parseInt(message[start]),        // id
        message[start + 1],                       // username
        message[start + 2],                       // nickname
        message[start + 3],                       // avatar
        Integer.parseInt(message[start + 4]),     // numberOfGame
        Integer.parseInt(message[start + 5]),     // numberOfWin
        Integer.parseInt(message[start + 6]),     // numberOfDraw
        Integer.parseInt(message[start + 7])      // rank
    );
}
    ...
    public void run() {
        ...
        try { 
            socketOfClient = new Socket("192.168.100.103", 7777);
